...
use WebreatheTest\app\WebreatheTestTable;
use WebreatheTest\WebreatheTestError as IError;

/**
 * Manage WebreatheTest database.
 *
 ...
 * @subpackage WebreatheTest/Database
 */
class WebreatheTestDatabase extends WebreatheTestTable
{
    /**
    ...
    private function initDefaultDbTab()
    {
        try {
            ...
            echo IError::triggerError("bdTable");
        }
    }
}
